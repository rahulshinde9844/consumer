    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> CreatePolicyRequest(CreatePolicy createPolicy)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                using var httpResponse = await client.PostAsync($"/api/Policy/createPolicy", content);
        ...
        public async Task<IActionResult> IssuePolicyRequest(IssuePolicy issuePolicy)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                using var httpResponse = await client.PostAsync($"/api/Policy/issuePolicy", content);
        ...
        public async Task<IActionResult> ViewPolicyRequest(ViewPolicy viewPolicy)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                using var httpResponse = await client.GetAsync($"/api/Policy/viewPolicy/{ConsumerId}/{BusinessId}/{PolicyId}");
