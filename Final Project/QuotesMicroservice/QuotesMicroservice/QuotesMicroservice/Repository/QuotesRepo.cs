...
namespace QuotesMicroservice.Repository
{
    ...
    public class QuotesRepo : IQuotesRepo
    {
        ...
        public string QuotesForPolicy(int PropertyValue, int BusinessValue, string PropertyType)
        {
            ...
            else if (PropertyValue >= 0 && PropertyValue <= 2 && BusinessValue >= 0 && BusinessValue <= 2 && PropertyType.ToLower() == "Factory in transit".ToLower())
            {
                return "100000";
            }
            else if (PropertyValue >= 3 && PropertyValue <= 5 && BusinessValue >= 3 && BusinessValue <= 5 && PropertyType.ToLower() == "Factory in transit".ToLower())
            {
                return "80000";
            }
            else if (PropertyValue >= 6 && PropertyValue <= 7 && BusinessValue >= 6 && BusinessValue <= 7 && PropertyType.ToLower() == "Factory in transit".ToLower())
            {
                return "60000";
            }
            else if (PropertyValue >= 8 && PropertyValue <= 10 && BusinessValue >= 8 && BusinessValue <= 10 && PropertyType.ToLower() == "Factory in transit".ToLower())
            {
                return "40000";
            }
