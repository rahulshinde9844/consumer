    ...
    public class PolicyService : IPolicyService
    {
        ...
        public string GetQuotes(int PropertyValue, int BusinessValue, string PropertyType)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var httpResponse = client.GetAsync($"/getQuotesForPolicy/{PropertyValue},{BusinessValue},{PropertyType}").Result;
        ...
        public ConsumerBusiness ConsumerDetail(string ConsumerId, string BusinessId)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var httpResponse = client.GetAsync($"/viewConsumerBusiness /{ConsumerId},{BusinessId}").Result;
                var responseString = httpResponse.Content.ReadAsStringAsync().Result;
