...
using Insureity_Portal.Repository;
...
namespace Insureity_Portal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PolicyContext>(options => options.UseInMemoryDatabase(databaseName: "policyDb"));
